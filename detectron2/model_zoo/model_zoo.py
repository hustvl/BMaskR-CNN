...
class _ModelZooUrls(object):
    ...
    CONFIG_PATH_TO_URL_SUFFIX = {
        ...
        "COCO-InstanceSegmentation/bmask_rcnn_R_50_FPN_1x.yaml": "137260431/model_final_a54504.pkl",
        ...
        "LVIS-InstanceSegmentation/bmask_rcnn_R_50_FPN_1x.yaml": "144219072/model_final_571f7c.pkl",
...
def get_checkpoint_url(config_path):
    ...
    Args:
        config_path (str): config file name relative to detectron2's "configs/"
            directory, e.g., "COCO-InstanceSegmentation/bmask_rcnn_R_50_FPN_1x.yaml"
...
def get(config_path, trained: bool = False):
    ...
    ::
        ...
        model = model_zoo.get("COCO-InstanceSegmentation/bmask_rcnn_R_50_FPN_1x.yaml", trained=True)
    """
